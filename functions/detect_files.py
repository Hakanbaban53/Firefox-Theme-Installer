#Comment lines for testing purposes. Uncomment them when you want to test the code.
...
class FileManager:
    ...
    def load_json_data(self, json_file_path):
        ...
        try:
            ...
            self.download_json_file(self.json_file_url, json_file_path)
            return self.load_json_data(json_file_path)
        except Exception as e:
            print(f"An error occurred: {e}")
        return {}

    def download_json_file(self, download_link, destination, max_retries=3):
        retries = 0
